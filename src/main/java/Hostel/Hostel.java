...
public final class Hostel {
    ...
    public boolean createCustomer(String name, String lastName, String dateOfBirth, String address, String zipCode, String city, String state, String country, String email){
